...
namespace ScoreBoard.data.character
{
    public class CorpsMember
    {
        ...
        /*
         * InitialiseBasicInfo(CorpsMember data)
         * - Id, Name, CorpsId, Description 세팅
         * - data: json 파일을 CorpsMember로 읽어온 데이터
         */
        protected void InitialiseBasicInfo(CorpsMember data)
        {
        ...
        /*
         * InitialisePasssiveSkills(CorpsMember data)
         * - 캐릭터의 패시브 스킬 초기화
         * - 각 내용은 객체에서 구현
         */
        protected virtual void InitialisePasssiveSkills(CorpsMember data) { }

        /*
         * InitialiseActiveSkills(CorpsMember data)
         * - 캐릭터의 액티브(사용) 스킬 초기화
         * - 각 내용은 객체에서 구현
         */
        protected virtual void InitialiseActiveSkills(CorpsMember data) { }
    }
}
